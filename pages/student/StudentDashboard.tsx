...
const StatusBadge = ({ status }: { status: 'enrolled' | 'completed' | 'withdrawn' | 'transferred' }) => {
    switch(status) {
        case 'enrolled':
        ...
        case 'transferred':
            return <span className="px-2.5 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">معادلة</span>;
        default:
            return null;
    }
};
